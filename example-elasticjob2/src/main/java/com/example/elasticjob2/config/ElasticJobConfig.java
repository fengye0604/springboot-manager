...
import com.example.elasticjob2.annotation.TaskJobSign;
import com.example.elasticjob2.listener.TaskJobListener;
...
public class ElasticJobConfig {
    ...
    public void initTaskJob() {
        ...
        Iterator iterator = jobMap.entrySet().iterator(); while (iterator.hasNext()) {
            // 自定义注解管理
