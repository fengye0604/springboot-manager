...
import com.example.examplerocketmqconsumer.dao.mysql.UserBeanMapper;
...
public class Consumer {
    ...
    MessageListenerConcurrently userMessageListener;
    /**
     * 消费者组
     */
    ...
    public Consumer() throws MQClientException {
        ...
        consumer.registerMessageListener((MessageListenerConcurrently) (msgs, context) -> {
            ...
            try {
                for (Message msg : msgs) {
                    ...
                    UserBean userBean = JsonUtil.parseJsonFromString(body, UserBean.class);
                    try {
        ...
        */
        consumer.registerMessageListener(userMessageListener);
        consumer.start();
