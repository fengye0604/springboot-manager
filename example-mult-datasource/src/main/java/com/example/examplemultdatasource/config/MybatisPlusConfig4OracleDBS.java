...
/**
 * Mybatis-plus oracle数据源配置
 * 多数据源配置依赖数据源配置
 * @see  DataSourceConfig
 */
@Configuration
@MapperScan(basePackages ="com.example.examplemultdatasource.dao.oracle", sqlSessionTemplateRef  = "oracleSqlSessionTemplate")
public class MybatisPlusConfig4OracleDBS {
    ...
    public SqlSessionFactory oracleSqlSessionFactory(@Qualifier("oracleDataSource") DataSource dataSource) throws Exception {
        ...
        sqlSessionFactory.setMapperLocations(new PathMatchingResourcePatternResolver().
                getResources("classpath:mybatis/oracle/*.xml"));
